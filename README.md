...
대상 데이터 많이 등장한 유명 작사가를 4명 선정하여, 노래 가사를 비교 분석하였다.
방탄소년단 작사를 맡은 ‘PDOGG’의 83곡, YG(블랙핑크, 빅뱅, 2NE1)의 작사를 맡은 ‘TEDDY’의 61곡, SM(엑소, 레드벨벳, 소녀시대, 슈퍼주니어)의 작사를 맡은 ‘KENZIE’의 65곡과 ‘조윤경’의 52곡이 분석 대상이다. 

분석 결과는 다음과 같이 나왔다.
① PDOGG : ‘네‘ 대신에 ‘니’를 사용하였고, ‘뭐’, ‘왜’, ‘진짜’, ‘근데’ 등의 직설적인 가사를 썼다. 즉 가사들이 부드러운 것 보다는 거친 편이다. ‘사랑’과 ‘LOVE’가 적은 대신, ‘꿈’, ‘최고’, ‘흥’, ‘노력’ 등의 ‘사랑’과 비교적 관련 없는 표현들이 많이 사용되었다. 이를 통해 꿈을 이루기 위해 노력하여 최고의 자리에 오른 내용의 ‘방탄소년단’ 노래가사는 PDOGG이 많이 쓴 것을 확인할 수 있었다.

② TEDDY : ‘사랑’과 ‘LIKE’가 많이 들어간 걸로 보아 사랑에 관한 이야기가 많다. 또한 
‘나’, ‘너’ 관련 대명사들이 가장 많이 들어간 것으로 보아, 상대에 대한 자신의 감정을 진솔하게 표현한 가사가 많을 것이다. ‘Lonely’, ‘없어’, ‘끝’, ‘없는’, ‘않아’, ‘없이’, ‘못’ 등의 부정적인 표현이 많이 들어간 것으로 보아, 이별과 관련된 가사가 많을 것이다. 그리고 ‘남자’가 많이 사용된 것으로 보아 TEDDY는 주로 여자 아이돌의 가사를 많이 썼을 것이다.

③ KENZIE : ‘싶어’, ‘원해’, ‘~거야’ 등의 의지나 소망을 표현하거나, ‘생각’, ‘Think’ 등의 자신의 생각을 표현하는 가사가 많다. ‘LOVE’, ‘좋아’ 등 상대방을 좋아한다는 가사가 많다. 즉, 그대를 좋아하는 나의 마음과, 이와 관련된 의지, 소망, 생각을 표현한 가사가 많을 것이다.

④ 조윤경 : ‘나’와 관련된 대명사보다 ‘너’와 관련된 대명사 사용이 많다. 즉, ‘나’보다는 ‘너’에 집중한 가사가 많다. ‘밤’, ‘빛’, ‘RED’, ‘손짓’, ‘느낌’, ‘향’, ‘기억’, ‘품’, ‘GOOD’ 등을 통해 ‘너’를 보거나 생각했을 때 떠오르는 ‘맘＇또는 ‘가슴‘ 속 이미지를 감각적으로 표현했을 것이다. 
‘모든’, ‘매일’, ‘함께’, ‘모두’, ‘오직’, ‘가득’ 등의 충만하고 가득 찬 듯한 표현을 통해 ‘너’를 
향한 마음이 가득 차 있음을 표현했을 것이다.

이처럼 작사가도 그들만의 특유의 분위기와 특징이 있다. 그렇기 때문에 아이돌은 본인이 추구하는 컨셉 또는 이미지에 맞게 가사를 잘 써줄 수 있는 작사가를 잘 만나는 것 또한 중요한 것을 알 수 있다.


<결론>
=============
국내 아이돌 시장이 이미 포화상태인 현 시점에서, 아이돌은 그들만의 ‘고유한 컨셉과 이미지’가 필요하다. 그리고 가사는 이를 확립하는 데 큰 영향을 줄 수 있고, 실제로도 연결되는 부분이 많기 때문에 노래 가사와 그룹의 분위기가 동떨어지지 않도록 해야 할 것이다. 또한 이렇게 타 그룹과 구분되는 특이점도 필요하긴 하지만, 이는 대중들이 거부감을 느끼지 않도록 어느 정도 보편성도 가지고 있어야하고 과하면 안 된다. 마지막으로 아이돌 노래도 시대에 따라 트랜드가 변화하기 때문에 이를 놓치지 않는 것은 물론, 한 발 먼저 나아가 선점할 수 있는 것이 중요하다.
  
아이돌과 K-POP을 응원하는 한 사람으로서, 앞으로의 아이돌 관련 분야가 세계로 더 뻗어나가서 지금보다도 더 많은 청춘들이 꿈을 이루고 무대에 오를 수 있기를 기원한다.
